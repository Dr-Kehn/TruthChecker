    ...
    <div id="accordion-collapse" className="accordion-collapse">
      ...
      <h2 id="accordion-collapse-heading-1">
        ...
        >
          ...
          <svg
            className={`accordion-icon ${expandedItems['accordion-collapse-body-1'] ? 'rotate-180' : ''}`}
            aria-hidden="true"
      ...
      <div
        ...
        className={`accordion-content ${expandedItems['accordion-collapse-body-1'] ? '' : 'hidden'}`}
      ...
      <h2 id="accordion-collapse-heading-2">
        ...
        >
          ...
          <svg
            className={`accordion-icon ${expandedItems['accordion-collapse-body-2'] ? 'rotate-180' : ''}`}
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 10 6"
      ...
      <div
        ...
        className={`accordion-content ${expandedItems['accordion-collapse-body-2'] ? '' : 'hidden'}`}
      ...
      <h2 id="accordion-collapse-heading-3">
        ...
        >
          <span className='mr-2'>What makes this different from traditional fact-checking platforms?</span>
          <svg
            className={`accordion-icon ${expandedItems['accordion-collapse-body-3'] ? 'rotate-180' : ''}`}
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 10 6"
      ...
      <div
        ...
        className={`accordion-content ${expandedItems['accordion-collapse-body-3'] ? '' : 'hidden'}`}
        aria-labelledby="accordion-collapse-heading-3"
      >
        <div className="accordion-panel">
          <p className="accordion-text">Traditional platforms rely on centralized authorities, while TruthCheck uses decentralized community verification.</p> 
        </div>
      </div>
       ...
       <h2 id="accordion-collapse-heading-4">
        ...
        >
          ...
          <svg
            className={`accordion-icon ${expandedItems['accordion-collapse-body-4'] ? 'rotate-180' : ''}`}
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 10 6"
      ...
      <div
        ...
        className={`accordion-content ${expandedItems['accordion-collapse-body-4'] ? '' : 'hidden'}`}
      ...
      >
       ...
       <h2 id="accordion-collapse-heading-5">
        ...
        >
          ...
          <svg
            className={`accordion-icon ${expandedItems['accordion-collapse-body-5'] ? 'rotate-180' : ''}`}
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 10 6"
      ...
      <div
        ...
        className={`accordion-content ${expandedItems['accordion-collapse-body-5'] ? '' : 'hidden'}`}
        aria-labelledby="accordion-collapse-heading-2"
      >
        <div className="accordion-panel">
          <p className="accordion-text">This app works ... </p>
