    ...
    <main className="min-h-screen bg-gradient-to-br from-[#1e004e] to-[#180144] text-white font-sans">
      ...
      <header className="flex items-center justify-between px-10 py-6">
        ...
        <nav className="space-x-6 hidden md:flex">
          <a href="#" className="text-[#43ffa3] font-medium">Home</a>
          <a href="#" className="hover:text-[#43ffa3] transition">Trending</a>
          <a href="#" className="hover:text-[#43ffa3] transition">Fact Check</a>
          <a href="#" className="hover:text-[#43ffa3] transition">Contact Us</a>
        </nav>
      ...
      <section className="flex flex-col items-center justify-center text-center px-4 py-16">
        <h1 className="text-4xl md:text-6xl font-bold leading-tight text-[#a8ffc4] mb-4">
          Not Sure If It’s <br className="hidden md:block" /> True? Check It Here
        </h1>
